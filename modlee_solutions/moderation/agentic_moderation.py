...
class ReviewModerationAgent:
    def __init__(self, llm, system_description, task, goal, decision_options, distilled_model_path, details_path, save_folder, allow_distilled_model=False, distilled_model_accuracy_threshold=90):
        """
        ...
        try:
            self.distilled_model_path = distilled_model_path#"./moderation_results/distilled_model.pth"
            self.details_path = details_path#"./moderation_results/distilled_model_details.json"
    ...
    def moderate_review_llm(self, review_text, context=""):
        ...
        self.save_to_json(folder_path=self.save_folder)
